  ...
  export default {
    ...
    methods: {
      ...
      async search(){
        ...
        reqJson.store_return_start_date = this.requestStartDateOption;
        reqJson.store_return_end_date = this.requestEndDateOption;
        reqJson.status = '8'; // 반품 조회 
          ...
          if (res.data.resultCode){
            for(var resData in resDataJson){
              this.totalData.push({ 
                ...
                , store_out_date: resDataJson[resData]['store_out_date']
