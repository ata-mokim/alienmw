 ...
 <el-table
   ...
   <el-table-column
     ...
     <template slot-scope="scope">
       <el-input id="inputBoxBarcode" size="medium" placeholder="Please input" v-model="scope.row.w_out_box_barcode"></el-input>
     </template>
   ...
   <el-table-column
     ...
     <template slot-scope="scope">
       <el-input id="inputStoreCode" size="medium" placeholder="Please input" v-model="scope.row.store_code"></el-input>
     </template>
   </el-table-column>
    ...
    methods: {
      ...
      save(){
        ...
        for(var resData in this.multipleSelection){
          this.multipleSelection[resData]['status'] = '4'
          this.multipleSelection[resData]['upd_user_id'] = this.$store.state.userId ;

          if ( this.multipleSelection[resData]['w_out_box_barcode'] =='' || this.multipleSelection[resData]['w_out_box_barcode'] == null )
          {
             this.$message.error('출고 박스 바코드를 입력해 주세요');
             return;
          }
          if ( this.multipleSelection[resData]['store_code'] =='' || this.multipleSelection[resData]['store_code'] == null )
          {
            this.$message.error('매장코드를 입력해 주세요');
            return;
          }
        }
